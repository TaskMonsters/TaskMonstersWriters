...
const LAND_ALIEN_DATA = {
    ...
    attackDamageMin: 25,
    attackDamageMax: 25,
    specialAbility: 'defend_evade_timesting',
    canDefend: true,
    canEvade: true,
    evasionChance: 0.20,
    timeStingAttack: true,
    timeStingChance: 0.25,
...
const MUSHROOM_GUARD_DATA = {
    ...
    attackDamageMax: 85,
    variableDamage: true,
    specialAbility: 'teleport_mushroom',
    canTeleport: true,
    teleportDamage: 20,
    teleportDuration: 3,
    mushroomAttack: true,
    mushroomEffectDuration: 2,
    mushroomMissChance: 0.40,
    mushroomSkipChance: 0.25,
